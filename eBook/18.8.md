...
（6）如何限制并发处理请求的数量：参考[章节14.11](14.11.html)

（7）如何在多核CPU上实现并行计算：参考[章节14.13](14.13.html)
...
（11）如何在同步调用运行时间过长时将之丢弃：参考[章节14.5](14.5.html) 第二个变体

（12）如何在通道中使用计时器和定时器：参考[章节14.5](14.5.html)

（13）典型的服务器后端模型：参考[章节14.4](14.4.html)

## 链接

- [目录](directory.html)
- 上一节：[文件](18.7.html)
- 下一节：[网络和网页应用](18.9.html)
