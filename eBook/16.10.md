...
译者注：该小结关于错误处理的观点，译者并不完全赞同，关于本小结的部分想法请参考[关于16.10.2小节错误处理的一些见解](Discussion_about_16.10.html)


依附于[第13章](13.0.html)模式的描述和[第17.1小节](17.1.html)与[第17.2.4小节](17.2.html)的总结。
...
这种方法可以很容易分辨出错误检测、错误通知和正常的程序逻辑（更详细的方式参考[第13.5小节](13.5.html)）。

**在开始阅读[第17章](17.0.html)前，先回答下列2个问题：**
...
- [目录](directory.html)
- 上一节：[闭包和协程的使用](16.9.html)
- 下一章：[Go 语言模式](17.0.html)
