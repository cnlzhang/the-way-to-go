...
通过应用可见性规则参考[4.2.1节](04.2.html)、[9.5 节](09.5.html)就可以禁止使用 new 函数，强制用户使用工厂方法，从而使类型变成私有的，就像在面向对象语言中那样。
...
new 和 make 这两个内置函数已经在第 [7.2.4](07.2.html) 节通过切片的例子说明过一次。
